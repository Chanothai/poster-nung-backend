...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "is_authenticated", sa.Boolean(), server_default="false", nullable=False
        ),
    ...
    op.create_index(
        "ix_posters_status_era_price",
        "posters",
        ["status", "era_decade", "price"],
        unique=False,
    )
    op.create_table(
        "users",
    ...
    op.create_index(
        "ix_poster_images_poster",
        "poster_images",
        ["poster_id", "sort_order"],
        unique=False,
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.UUID(), nullable=False),
        sa.Column(
            "status", reservation_status, server_default="active", nullable=False
        ),
        sa.Column("expires_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column(
            "created_at",
